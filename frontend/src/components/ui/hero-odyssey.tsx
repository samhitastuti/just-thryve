  ...
  return (
    <div className="relative w-full bg-black text-white overflow-hidden">
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
          ...
          <motion.div
            ...
            <div className="flex flex-col items-center justify-center h-full space-y-6 text-lg">
              ...
              <button 
                ...
                className="px-6 py-3 bg-gray-800/50 rounded-full"
              >
                Start
              </button>
              <button 
              ...
              <button 
                onClick={() => { setMobileMenuOpen(false); document.getElementById('solution')?.scrollIntoView({ behavior: 'smooth' }); }}
                className="px-6 py-3"
              >
                Solution
              </button>
              <button 
                onClick={() => { setMobileMenuOpen(false); document.getElementById('problem')?.scrollIntoView({ behavior: 'smooth' }); }}
                className="px-6 py-3"
              >
                Problem
              </button>
              ...
              <button 
                onClick={() => { setMobileMenuOpen(false); navigate('/dashboard/apply'); }}
        ...
        >
          <motion.div variants={itemVariants}>
            <FeatureItem name="ESG-Positive" value="SMEs" position="left-0 sm:left-10 top-40" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="OCEN" value="Enabled" position="left-1/4 top-24" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="AI" value="Underwriting" position="right-1/4 top-24" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Flow-Based" value="Credit" position="right-0 sm:right-10 top-40" />
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            <span>Next-Gen ESG Lending Platform</span>
          ...
          <motion.h2
            variants={itemVariants}
            className="text-3xl md:text-5xl pb-3 font-light bg-gradient-to-r from-indigo-400 via-cyan-400 to-indigo-400 bg-clip-text text-transparent"
          >
            Creditworthy by Design
          </motion.h2>
          ...
          >
            Empowering sustainable SMEs with real-time, flow-based credit. 
            Lightning-fast underwriting meets ESG-conscious lending.
          </motion.p>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={() => navigate('/dashboard/apply')}
            className="mt-[50px] px-8 py-3 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-colors"
          >
            Apply for Credit
          </motion.button>
        </motion.div>
      ...
      >
        ...
        <div className="absolute top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gradient-to-b from-indigo-500/20 to-purple-600/10 blur-3xl"></div>
